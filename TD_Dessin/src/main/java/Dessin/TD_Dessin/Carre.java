...
/**
 *implemantation de la classe Carre 
 *pour definir un la forme géométrique carre.
 * @author rachida ouchene.
 * 
 */
public class Carre extends Formes_Graphiques {
	/**
     *la possition de carre
	...
	private int cote;
	/**
	* Constructor Carre qu'inisialise @see Coor par ces coordonnée 
	* et @see cote par la demansion de cote et passe le name a la super classe.
	 * @param name :
	 * le nom de carre.
	...
	/**
     * Deplace le carre en rajoutant le deplacement passer en 
     * parmetre pour les Coordonnée se carre 
