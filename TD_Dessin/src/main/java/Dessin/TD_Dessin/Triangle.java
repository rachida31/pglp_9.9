...
/**
 *implemantation de la classe Triangle 
 *pour definir un la forme géométrique Triangle.
 * @author rachida ouchene.
 * 
 */
public class Triangle extends Formes_Graphiques {
	/**
     *la possition d'un point de Triangle qu'est
	...
	/**
	* Constructor Triangle qu'inisialise @see Coor1 par ces coordonnée 
	* et @see Coor2 par ces coordonnée et @see Coor3 par ces coordonnée
	 * @param Triangle :
	 * le nom de carre.
     ...
     * parmetre pour les Coordonnée de ce Triangle 
