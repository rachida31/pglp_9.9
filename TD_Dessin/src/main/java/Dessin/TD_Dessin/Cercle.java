...
/**
 *implemantation de la classe Cercle 
 *pour definir un la forme géométrique Cercle.
 * @author rachida ouchene.
 * 
 */
public class Cercle extends Formes_Graphiques {
	/**
     *la possition de centre de Cercle
	...
	/**
     *la demansion de rayon de Cercle 
     * qu'est de type int.
     * @see Cercle#Cercle().
     * @see Cercle#getRayon().
     */
	private int rayon;
	/**
	* Constructor Cercle qu'inisialise @see Coor par ces coordonnée 
	* et @see rayon par la demansion de rayon et passe le name a la super classe.
	 * @param name :
	 * le nom de Cercle.
     ...
     * parmetre pour les Coordonnée de ce Cercle 
