...
public class TriangleDAO implements DAO<Triangle> {
	 ...
	 * @param conn .
	 */
	public TriangleDAO(final Connection conn) {
		this.conn = conn;
	}
...
// TODO Auto-generated method stub
	...
	/**
	 * Modifier les valeurs tx1 et t1,tx2 et ty2 , tx3 et ty3 dans la base de
...
// TODO Auto-generated method stub
		try {
			PreparedStatement prepare = conn.prepareStatement(
					"UPDATE Triangle SET tx1 = ?,ty1 = ? ,tx2 = ?,ty2 = ? , " 
							+ "tx3 = ?,ty3 = ? WHERE nomt = ?");
...
// TODO Auto-generated method stub
	...
	/**
	 * ReCherche un Triangle dans la table Triangle de la base appartir de son 
	 * nom.
	 ...
	 */
	@Override
	public Triangle read(final String nom) {
// TODO Auto-generated method stub
		Coordonnee coor1;
		Coordonnee coor2;
		Coordonnee coor3;
		...
		try {
			...
			if (result.next()) {
				coor1 = new Coordonnee(result.getInt("tx1"),
						result.getInt("ty1"));
				coor2 = new Coordonnee(result.getInt("tx2"),
						result.getInt("ty2"));
				coor3 = new Coordonnee(result.getInt("tx3"),
						result.getInt("ty3"));
				triangle = new Triangle(result.getString("nomt"), coor1,
						coor2, coor3);
				result.close();
			}
		} catch (SQLException e) {
