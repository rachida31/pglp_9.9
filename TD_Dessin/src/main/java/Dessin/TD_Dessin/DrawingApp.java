...
/**
 *implemantation de la classe DrawingApp 
 *qui fait interger avec l'utilisteur.
...
public class DrawingApp {
	 ...
	 /**
	     *un attribut 
	     * de type DrawingTUI pour annalyser l'entree de l'utilisateur.
	     */
	  private DrawingTUI drt;
	  /**
		* Constructor DrawingApp qui va instancier l'objet drt qu'est de type DrawingTUI.
		 * */
	...
	System.out.println("2- Dessiner un groupe de Forme si les formes existes exp: \\\"g1 = Groupe (c1,a1,r1,t1) ");
	...
	System.out.println("5- Rechercher un  dessin que vous avez realiser entree find exp:\" find(c1)\"");
	System.out.println("6- pout quiter entree exit ");

	 
	}
	/**
	 * methode permetant d'executer les differnents commandes envoyées par l'interface de l'utilisateur 
	 * @throws Exception
	 * */
