...
/**
 * implemantation de la classe Carre pour definir un la forme géométrique carre.
 * 
...
public class Carre extends Formes_Graphiques {
	...
	/**
	 * Constructor Carre qu'inisialise @see Coor par ces coordonnée et @see cote par
	 * la demansion de cote et passe le name a la super classe.
	 * 
	 * @param name  : le nom de carre.
	 * @param Coor: les coordonnée de carre.
	 * @param cote  le cote de carre.
	 */
	...
	@Override
	public void print() {
		String carre = this.name + " : carre ((coté:" + cote + ") " + ("(x:" + Coor.getX() + "," + "y:" + Coor.getY())
				+ "))";
		System.out.println(carre);
	}

	/**
	 * Deplace le carre en rajoutant le deplacement passer en parmetre pour les
	 * Coordonnée se carre grace a l'appelle de la fonction move de la classe
	 * Coordonnee.
	 */
	@Override
