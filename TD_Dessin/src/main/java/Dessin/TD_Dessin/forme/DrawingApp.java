...
public class DrawingApp {
	/**
	 * un attribut de type DrawingTUI pour annalyser l'entree
	 * de l'utilisateur.
	 */
	private DrawingTUI drt;
	/**
	 * Constructor DrawingApp qui va instancier l'objet drt
	 * qu'est de type
	 * DrawingTUI.
	 ...
	 */
	public final void menu1() {
		System.out.println("*************************** "
				+ "Bienvenue au logiciel "
				+ "de dessin ***************************");
		System.out.println(" Vous avis les choix  des "
				+ "commandes suivantes :");
		...
		System.out.println("\n      pour un Cercle exp: "
				+ "\"c1 = Cercle "
				+ "((0, 0), 50) \"");
		System.out.println("      pour un Carre exp:\"a1 ="
				+ " Carre((1, 2),5) \"");
		System.out.println("2- Dessiner un groupe de "
				+ "Forme si les formes "
				+ "existes exp: \\\"g1 = Groupe"
				+ " (c1,a1,r1,t1) ");
		System.out.println("3- Deplacer une forme ou"
				+ " un groupe si ils "
				+ "existent ");
		...
		System.out.println("      pour un Carre exp:"
				+ "\"move(a1(9, 3))\"");
		System.out.println("      pour un Groupe exp:"
				+ " \"move(g1(7,3))\"");
		System.out.println("5- Rechercher un  dessin "
				+ "que vous avez realiser "
	...
	/**.
	 * methode permetant d'executer les differnents commandes
	 * envoyées par
