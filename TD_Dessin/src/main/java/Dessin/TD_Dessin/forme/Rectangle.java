...
/**
 * implemantation de la classe Rectangle pour definir un la forme géométrique
 * Rectangle.
 * 
...
public class Rectangle extends Formes_Graphiques {
	/**
	 * la possition de Rectangle de type Coordonnee (int ,int).
	 * 
	...
	/**
	 * Constructor Rectangle qu'inisialise @see Coor par ces coordonnée et @see
	 * longeur et @see lagreur de Rectangle ainsi passe le name a la super classe.
	 * 
	...
	@Override
	public void print() {
		String rectangle = this.name + " : Rectangle ((longueur:" + longueur + ") " + ",(largeur:" + largeur + ") "
				+ (",(x:" + Coor.getX() + "," + "y:" + Coor.getY()) + "))";
		System.out.println(rectangle);
	}

	/**
	 * Deplace le Rectangle en rajoutant le deplacement passer en parmetre pour les
	 * Coordonnée de ce Rectangle grace a l'appelle de la fonction move de la classe
	 * Coordonnee.
	 */
	@Override
