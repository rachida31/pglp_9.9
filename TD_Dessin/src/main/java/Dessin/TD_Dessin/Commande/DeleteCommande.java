...
public class DeleteCommande implements Commande {
	...
	/**
	 * constructeur DeleteCommande.
	 * qui initialise this.forme a forme et instancier l'objet daof de type DaoFactory.
	 * @param forme c'est un objet de type Formes_Graphiques que nous voulons supprimer.
	 * @see DeleteCommande#forme .
	 * @see DeleteCommande#daof .
	 * @exception SQLException
	 * */
	public DeleteCommande(Formes_Graphiques forme) throws SQLException
	{
		this.forme=forme;
		this.daof=new DaoFactory(); 
	}
	/**
	 * Méthode execute qui fait appelle a la méthode delete selon le type de l'objet forme  pour 
	 * supperimer une forme dans la base.
	 * @throws Exception 
	 * 
	 * */
	@Override
